class Solution {
    ...
    // If an element is 0, we mark the corresponding row and column in the first row and first column.
    // After marking, we iterate through the matrix again and set the elements to 0 based on the markers.
